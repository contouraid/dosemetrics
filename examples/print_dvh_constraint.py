...
def print_dvh_constraint(input_folder: str, output_folder: str):
    ...
    dose_volume, structure_masks = read_dose_and_mask_files(dose_file, mask_files)
    dose_df = scores.dose_summary(dose_volume, structure_masks)
    ...
    for structure in structures:
        ...
        if struct_name not in constraints.index:
            ...
            bins, values = dvh.compute_dvh(dose_volume, oar_mask)
            fig = plt.figure()
            plt.plot(
            ...
            if constraint_type == "max":
                ...
                mean_dose = dvh.mean_dose(dose_volume, oar_mask)
